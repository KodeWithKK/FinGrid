  ...
  ({ maxHeight = 200, className, ...restProps }, ref) => {
    ...
    return (
      <textarea
        ...
        ref={localRef}
        className={cn(
          "scroller placeholder:text-muted-foreground focus:border-primary border-input block w-full resize-none rounded-md border bg-transparent p-2 text-sm transition-colors focus:outline-0",
          className,
        )}
        onInput={(e) => {
